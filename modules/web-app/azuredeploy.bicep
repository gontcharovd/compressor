...
param postgresHost string = 'postgresdatabaseepq74eywt4twa.postgres.database.azure.com'
...
module buildContainerImage 'br/public:deployment-scripts/build-acr:1.0.1' = {
  ...
  params: {
    ...
    location: location
    gitRepositoryUrl: 'https://github.com/gontcharovd/compressor-streamlit-app.git'
    gitRepoDirectory: '.'
